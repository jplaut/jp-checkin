...
def welcome():
	if request.args.get('code', None):
		...
		friends = GetFriends.perform(username, 0, interval, access_token)
		checkins = AggregateCheckins.perform(username, friends, access_token)
		checkin_metadata=MoveCheckinsToDatabase.perform(checkins, username)
		
		print checkin_metadata
